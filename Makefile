...
mac:
	rm -r Mac_Release && mkdir Mac_Release && gcc -Wall -c enigma.c && gcc -Wall -c interface.c && gcc -Wall -o enigma enigma.c interface.c && mv enigma.o Mac_Release/enigma.o && mv interface.o Mac_Release/interface.o && mv enigma Mac_Release/enigma
